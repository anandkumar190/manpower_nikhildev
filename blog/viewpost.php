            ...
            <div class="col-md-12 nopadding">
               <div class="col-md-7 nopadding">
                  ...
                  echo '<div>';
                     ...
                     echo  '<a href="'.$row['postSlug'].'"><img src="admin/uploads/'.$row['image'].'" style="width:100%; height:350px;"></a>';
                     echo '</div>';
