...
<head>
    ...
    <title>Add New Post ~ Levycon</title>
    <!-- Style Sheet -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" placeholder="Enter post title"
                                                class="form-control form-control-line" name='postTitle'
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name='postDesc' cols='60'
                                                rows='4'><?php if(isset($error)){ echo $_POST['postDesc'];}?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name='postCont' cols='60'
